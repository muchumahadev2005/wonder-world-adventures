    ...
    <div className="min-h-screen flex items-center justify-center p-3 sm:p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="relative">
          ...
          {/* Role toggle */}
          <div className="flex p-1 rounded-2xl bg-white/15 border border-white/30 mb-4">
            {(["child", "parent"] as const).map((r) => (
              <button
                ...
                className={`flex-1 py-2 rounded-xl text-sm font-bold capitalize transition ${
                  role === r
                    ? "bg-gradient-to-r from-amber-200 to-amber-400 text-amber-950 shadow"
                    : "text-white/80"
                }`}
              >
                {r}
          ...
          <div className="space-y-3">
            <div className="relative">
              <User className="w-5 h-5 absolute left-3.5 top-1/2 -translate-y-1/2 text-white/70" />
