      ...
      <div className="pt-24 pb-12 px-4 max-w-5xl mx-auto relative z-10">
        <motion.div className="text-center mb-8" initial={{ y: -30, opacity: 0 }} animate={{ y: 0, opacity: 1 }}>
          <h1 className="font-display text-4xl font-bold text-gradient-primary flex items-center justify-center gap-3">
            <BookOpen className="w-10 h-10 text-primary" /> Story Time
          </h1>
        ...
        {activeStory ? (
          <motion.div
            className="glass-card-strong p-8 max-w-lg mx-auto"
          ...
          >
            ...
            <h2 className="font-display text-2xl font-bold text-center mb-2">{activeStory.title}</h2>
            ...
            <AnimatePresence mode="wait">
              <motion.p
                key={page}
                className="text-lg font-body text-foreground leading-relaxed text-center min-h-[100px]"
            ...
            <div className="flex justify-between mt-6">
              <button
                ...
                disabled={page === 0}
                className="glossy-btn px-6 py-2 text-primary-foreground font-bold disabled:opacity-30"
              >
                ← Back
              </button>
              {page < activeStory.pages.length - 1 ? (
                <motion.button
                  ...
                  className="glossy-btn px-6 py-2 text-primary-foreground font-bold flex items-center gap-1"
            ...
            {stories.map((story) => {
              ...
              return (
                <motion.button
                  ...
                  className={`glass-card-strong p-6 text-center relative ${locked ? 'opacity-70' : ''}`}
                ...
                >
                  ...
                  <h3 className="font-display text-sm font-bold text-foreground">{story.title}</h3>
